...
void MTCTaskNode::doTask() {
  ...
  // publishes the solution to be visualized in RViz
...
#pragma GCC diagnostic pop
  ...
  task.add(std::move(stage_state_current)); // a generator stage
  ...
  task.add(std::move(stage_open_hand)); // a propagator stage
